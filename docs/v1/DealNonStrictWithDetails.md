...
**average_time_to_won** | Option<[**models::DealNonStrictWithDetailsAllOfAverageTimeToWon**](dealNonStrictWithDetails_allOf_average_time_to_won.md)> |  | [optional]
**average_stage_progress** | Option<**f64**> | The average of the deal stage progression | [optional]
**age** | Option<[**models::DealNonStrictWithDetailsAllOfAge**](dealNonStrictWithDetails_allOf_age.md)> |  | [optional]
**stay_in_pipeline_stages** | Option<[**models::DealNonStrictWithDetailsAllOfStayInPipelineStages**](dealNonStrictWithDetails_allOf_stay_in_pipeline_stages.md)> |  | [optional]
