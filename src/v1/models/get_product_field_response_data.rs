...
/// GetProductFieldResponseData : All data for the product field
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetProductFieldResponseData {
...
impl GetProductFieldResponseData {
    /// All data for the product field
    pub fn new(name: String, field_type: FieldType) -> GetProductFieldResponseData {
