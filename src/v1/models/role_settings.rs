...
/// RoleSettings : The settings for the role
...
pub struct RoleSettings {
    ...
    pub deal_default_visibility: Option<f64>,
    ...
    pub lead_default_visibility: Option<f64>,
    ...
    pub org_default_visibility: Option<f64>,
    ...
    pub person_default_visibility: Option<f64>,
    ...
    pub product_default_visibility: Option<f64>,
    ...
    pub deal_access_level: Option<f64>,
    ...
    pub org_access_level: Option<f64>,
    ...
    pub person_access_level: Option<f64>,
    ...
    pub product_access_level: Option<f64>,
}

impl RoleSettings {
    /// The settings for the role
    pub fn new() -> RoleSettings {
        RoleSettings {
