...
/// GetDealsSummaryResponseDataValuesTotal : The total values of the deals grouped by deal currency
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDealsSummaryResponseDataValuesTotal {
    ...
    pub value_converted: Option<f64>,
...
impl GetDealsSummaryResponseDataValuesTotal {
    /// The total values of the deals grouped by deal currency
    pub fn new() -> GetDealsSummaryResponseDataValuesTotal {
