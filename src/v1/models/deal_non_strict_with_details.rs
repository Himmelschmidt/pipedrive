...
pub struct DealNonStrictWithDetails {
    /// The ID of the deal
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
    #[serde(rename = "creator_user_id", skip_serializing_if = "Option::is_none")]
    pub creator_user_id: Option<Box<models::DealAllOfCreatorUserId>>,
    #[serde(rename = "user_id", skip_serializing_if = "Option::is_none")]
    pub user_id: Option<Box<models::DealUserDataWithId>>,
    #[serde(rename = "person_id", skip_serializing_if = "Option::is_none")]
    pub person_id: Option<Box<models::DealPersonDataWithId>>,
    #[serde(rename = "org_id", skip_serializing_if = "Option::is_none")]
    pub org_id: Option<Box<models::DealOrganizationDataWithId>>,
    ...
    #[serde(rename = "arr", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "mrr", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "acv", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "arr_currency", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub arr_currency: Option<Option<String>>,
    ...
    #[serde(rename = "mrr_currency", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub mrr_currency: Option<Option<String>>,
    ...
    #[serde(rename = "acv_currency", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub acv_currency: Option<Option<String>>,
    #[serde(rename = "average_time_to_won", skip_serializing_if = "Option::is_none")]
    pub average_time_to_won: Option<Box<models::DealNonStrictWithDetailsAllOfAverageTimeToWon>>,
    /// The average of the deal stage progression
    #[serde(rename = "average_stage_progress", skip_serializing_if = "Option::is_none")]
    pub average_stage_progress: Option<f64>,
    #[serde(rename = "age", skip_serializing_if = "Option::is_none")]
    pub age: Option<Box<models::DealNonStrictWithDetailsAllOfAge>>,
    #[serde(rename = "stay_in_pipeline_stages", skip_serializing_if = "Option::is_none")]
    pub stay_in_pipeline_stages: Option<Box<models::DealNonStrictWithDetailsAllOfStayInPipelineStages>>,
    ...
    pub last_activity: Option<Option<serde_json::Value>>,
    /// The details of the next activity associated with the deal
    #[serde(rename = "next_activity", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub next_activity: Option<Option<serde_json::Value>>,
}

impl DealNonStrictWithDetails {
    pub fn new() -> DealNonStrictWithDetails {
        DealNonStrictWithDetails {
            ...
            mrr_currency: None,
            acv_currency: None,
            average_time_to_won: None,
            average_stage_progress: None,
            age: None,
            stay_in_pipeline_stages: None,
            last_activity: None,
            next_activity: None,
        }
    }
