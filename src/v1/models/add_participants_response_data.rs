...
/// AddParticipantsResponseData : The object of participant
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddParticipantsResponseData {
    ...
    pub owner_id: Option<Box<models::Owner>>,
    #[serde(rename = "org_id", skip_serializing_if = "Option::is_none")]
    pub org_id: Option<Box<models::RelationshipOrganizationInfoItemWithActiveFlag>>,
...
impl AddParticipantsResponseData {
    /// The object of participant
    pub fn new() -> AddParticipantsResponseData {
