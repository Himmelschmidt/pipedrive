...
pub struct GetProjectGroupsResponse {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetProjectGroupsResponseDataInner>>,
...
impl GetProjectGroupsResponse {
    pub fn new() -> GetProjectGroupsResponse {
