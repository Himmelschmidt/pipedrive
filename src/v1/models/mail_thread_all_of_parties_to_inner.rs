...
/// MailThreadAllOfPartiesToInner : Member of a thread
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MailThreadAllOfPartiesToInner {
...
impl MailThreadAllOfPartiesToInner {
    /// Member of a thread
    pub fn new() -> MailThreadAllOfPartiesToInner {
