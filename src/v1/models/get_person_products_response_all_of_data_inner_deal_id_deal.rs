...
pub struct GetPersonProductsResponseAllOfDataInnerDealIdDeal {
    /// The ID of the deal
    ...
    #[serde(rename = "first_add_time", skip_serializing_if = "Option::is_none")]
    pub first_add_time: Option<String>,
...
impl GetPersonProductsResponseAllOfDataInnerDealIdDeal {
    pub fn new() -> GetPersonProductsResponseAllOfDataInnerDealIdDeal {
