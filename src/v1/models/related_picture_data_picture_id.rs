...
/// RelatedPictureDataPictureId : The ID of the picture
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RelatedPictureDataPictureId {
    ...
    pub pictures: Option<Box<models::PictureDataPictures>>,
}

impl RelatedPictureDataPictureId {
    /// The ID of the picture
    pub fn new() -> RelatedPictureDataPictureId {
