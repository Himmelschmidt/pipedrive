...
pub struct MailMessageData {
    ...
    pub from: Option<Vec<models::MailMessageDataFromInner>>,
    /// The array of mail message receiver (object)
    #[serde(rename = "to", skip_serializing_if = "Option::is_none")]
    pub to: Option<Vec<models::MailMessageDataFromInner>>,
    /// The array of mail message copies (object)
    #[serde(rename = "cc", skip_serializing_if = "Option::is_none")]
    pub cc: Option<Vec<models::MailMessageDataFromInner>>,
    /// The array of mail message blind copies (object)
    #[serde(rename = "bcc", skip_serializing_if = "Option::is_none")]
    pub bcc: Option<Vec<models::MailMessageDataFromInner>>,
...
impl MailMessageData {
    pub fn new() -> MailMessageData {
        MailMessageData {
            id: None,
            from: None,
            to: None,
