...
pub struct GetProjectPhasesResponse {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetProjectPhasesResponseDataInner>>,
...
impl GetProjectPhasesResponse {
    pub fn new() -> GetProjectPhasesResponse {
