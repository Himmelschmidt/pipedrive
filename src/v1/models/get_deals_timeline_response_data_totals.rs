...
/// GetDealsTimelineResponseDataTotals : The total values of deals for the given period
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetDealsTimelineResponseDataTotals {
...
impl GetDealsTimelineResponseDataTotals {
    /// The total values of deals for the given period
    pub fn new() -> GetDealsTimelineResponseDataTotals {
