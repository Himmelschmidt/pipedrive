...
/// GetAssociatedFilesResponseAllOfDataInner : The file data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetAssociatedFilesResponseAllOfDataInner {
    /// The ID of the file
...
impl GetAssociatedFilesResponseAllOfDataInner {
    /// The file data
    pub fn new() -> GetAssociatedFilesResponseAllOfDataInner {
