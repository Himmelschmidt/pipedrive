...
pub struct GetMailThreadMessagesResponseAllOfDataInner {
    ...
    pub cc: Option<Vec<models::MailThreadAllOfPartiesToInner>>,
    /// Participants of the Bcc
    #[serde(rename = "bcc", skip_serializing_if = "Option::is_none")]
    pub bcc: Option<Vec<models::MailThreadAllOfPartiesToInner>>,
...
impl GetMailThreadMessagesResponseAllOfDataInner {
    pub fn new() -> GetMailThreadMessagesResponseAllOfDataInner {
