...
pub struct MergePersonItem {
    ...
    pub phone: Option<Vec<models::PersonAllOfPhoneInner>>,
    ...
    pub email: Option<Vec<models::PersonAllOfEmailInner>>,
    ...
    pub picture_id: Option<Box<models::PersonAllOfPictureId>>,
    ...
    #[serde(rename = "participant_open_deals_count", skip_serializing_if = "Option::is_none")]
    pub participant_open_deals_count: Option<i32>,
    /// The count of closed participant deals related with the item
    #[serde(rename = "participant_closed_deals_count", skip_serializing_if = "Option::is_none")]
    pub participant_closed_deals_count: Option<i32>,
}

impl MergePersonItem {
    pub fn new() -> MergePersonItem {
        MergePersonItem {
            id: None,
            company_id: None,
            active_flag: None,
            ...
            participant_open_deals_count: None,
            participant_closed_deals_count: None,
        }
    }
}
