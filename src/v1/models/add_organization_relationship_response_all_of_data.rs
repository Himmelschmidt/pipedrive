...
pub struct AddOrganizationRelationshipResponseAllOfData {
    ...
    pub rel_owner_org_id: Option<Box<models::RelationshipOrganizationInfoItem>>,
    #[serde(rename = "rel_linked_org_id", skip_serializing_if = "Option::is_none")]
    pub rel_linked_org_id: Option<Box<models::RelationshipOrganizationInfoItem>>,
...
impl AddOrganizationRelationshipResponseAllOfData {
    pub fn new() -> AddOrganizationRelationshipResponseAllOfData {
