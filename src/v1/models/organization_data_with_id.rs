...
/// OrganizationDataWithId : The ID of the organization associated with the item
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrganizationDataWithId {
...
impl OrganizationDataWithId {
    /// The ID of the organization associated with the item
    pub fn new() -> OrganizationDataWithId {
