...
pub struct GetOrganizationItem {
    ...
    pub picture_id: Option<Box<models::BaseOrganizationItemAllOfPictureId>>,
...
impl GetOrganizationItem {
    pub fn new() -> GetOrganizationItem {
        GetOrganizationItem {
            id: None,
            company_id: None,
            owner_id: None,
