...
/// RelatedDealDataDealId : The ID of the deal which is associated with the item
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RelatedDealDataDealId {
...
impl RelatedDealDataDealId {
    /// The ID of the deal which is associated with the item
    pub fn new() -> RelatedDealDataDealId {
