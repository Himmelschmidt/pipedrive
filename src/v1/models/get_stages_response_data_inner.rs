...
pub struct GetStagesResponseDataInner {
    /// The ID of the stage
    ...
    #[serde(rename = "pipeline_deal_probability", skip_serializing_if = "Option::is_none")]
    pub pipeline_deal_probability: Option<bool>,
}

impl GetStagesResponseDataInner {
    pub fn new() -> GetStagesResponseDataInner {
        GetStagesResponseDataInner {
            ...
            update_time: None,
            pipeline_name: None,
            pipeline_deal_probability: None,
        }
    }
}
