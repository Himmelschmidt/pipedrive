...
impl AddCallLogRequest {
    pub fn new(outcome: Outcome, to_phone_number: String, start_time: String, end_time: String) -> AddCallLogRequest {
        AddCallLogRequest {
            user_id: None,
            activity_id: None,
            subject: None,
